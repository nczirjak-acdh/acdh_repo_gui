...
CREATE TEMPORARY TABLE root_meta AS (
	...
	from rootids as ri 
	left join metadata_view as mv  on ri.rootid = mv.id
	where 
	mv.property IN ('https://vocabs.acdh.oeaw.ac.at/schema#hasTitle', 'https://vocabs.acdh.oeaw.ac.at/schema#hasDescription',
					'https://vocabs.acdh.oeaw.ac.at/schema#hasAvailableDate','https://vocabs.acdh.oeaw.ac.at/schema#hasAccessRestriction',
					'https://vocabs.acdh.oeaw.ac.at/schema#hasTitleImage', 'https://vocabs.acdh.oeaw.ac.at/schema#hasIdentifier'
				)
	OR mv.type = 'ID'
);
